...
export default function Profile({ user, premium }: ProfileProps){
    ...
    return(
        <>
            <Head>
                <title>BarberWise - Minha Conta</title>
            </Head>
            <Sidebar>
                <Flex direction="column" alignItems="flex-start" justifyContent="flex-start">
                    ...
                    <Flex pt={8} pb={8} background="barber.400" maxW="700px" w="100%" direction="column" alignItems="center" justifyContent="center">
                        <Flex direction="column" w="85%">
                            <Text mb={2} color="white" fontSize="xl" fontWeight="bold">Nome da barbearia:</Text>
                            <Input
                                w="100%"
                                background="gray.900"
                            ...
                            <Text mb={2} color="white" fontSize="xl" fontWeight="bold">Endereço:</Text>
                            <Input
                                w="100%"
                                background="gray.900"
                            ...
                            <Text mb={2} color="white" fontSize="xl" fontWeight="bold">Plano atual:</Text>
                            <Flex
                                direction="row"
                                w="100%"
                                mb={3}
